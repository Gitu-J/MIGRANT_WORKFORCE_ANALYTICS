...
The aim of this project is to develop a data-driven analytical framework for examining workforce instability and retention patterns among migrant care workers in the UK social care sector.  
## Data Sources
...
The project is limited to secondary quantitative data and does not involve primary data collection, interviews or surveys of care workers. The findings are intended to provide data-driven insights into workforce planning and retention challenges rather than establish direct causal relationships.

## Repository Purpose

This repository contains the datasets, analytical notebooks, outputs and Power BI materials supporting the dissertation research project.
